...
def relatorioFuncionarios():
    ...
    print("Verifique o seu relatório de funcionários na pasta.")
...
def relatorioVeiculos():
    ...
    print("Verifique o seu relatório de veículos na pasta.")
...
def funcEstacionamento(veiculo, vetorLinhaVeiculo, removerVeiculo, listarVeiculo):
    ...
    opcao = input("_")
    if opcao == "1":
        MonitoramentoVagas.cadastrarVeiculo()
    elif opcao == "2":
        MonitoramentoVagas.listarVeiculo()
    elif opcao == "3":
        MonitoramentoVagas.removerVeiculo()
    elif opcao == "4":
